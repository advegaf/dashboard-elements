...
export function RetentionCard({ data, rate, memberCount, trend, dateRange, loading, error }: RetentionCardProps) {
  ...
  return (
    <div className={styles.card} style={{ '--glow-color': glowColor } as React.CSSProperties}>
      <div className={styles.titleRow}>
        <h2 className={styles.title}>Retention Rate</h2>
      ...
      <div className={styles.content}>
        <div className={styles.stats}>
          {loading ? (
            ...
            <>
              <div className={styles.bigNumber}>{rate}</div>
              <div className={styles.unit}>of {memberCount.toLocaleString()} members</div>
              {trend && (
